...
export class SubSystemController {
    ...
    @ApiOkResponse({ description: 'Succesfully returned Subsystems.', type: [SubSystem] })
    ...
    @ApiOkResponse({ description: 'Succesfully returned a Subsystem with given ID.', type: SubSystem })
